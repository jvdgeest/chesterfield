...
namespace Chesterfield
{
  public partial class CouchDatabase : CouchBase
  {
    ...
    /// <summary>
    /// <para>Creates a document using the provided JSON. This method lets 
    /// CouchDB generate the document ID for you.</para>
    ...
    /// <summary>
    /// <para>Creates a document using the provided JSON.</para>
    /// <para>(This method is asynchronous.)</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Updates a document using the provided JSON.</para>
    /// <para>(This method is asynchronous.)</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Retrieves a document in a JSON string format.</para>
    /// <para>(This method is asynchronous.)</para>
    /// </summary>
    /// <param name="id">ID of the CouchDB document.</param>
    /// <param name="result"></param>
    ...
    /// <summary>
    /// <para>Checks if a document exists.</para>
    /// <para>(This method is asynchronous.)</para>
    /// </summary>
    /// <param name="id">ID of the CouchDB document.</param>
    /// <param name="result"></param>
    ...
    /// <summary>
    /// <para>Creates a document based on a type that inherits from the 
    /// ICouchDocument interface. If the ICouchDocument does not have an ID, 
    /// then CouchDB will generate it for you.</para>
    /// <para>(This method is asynchronous.)</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Updates a document using an ICouchDocument object.</para>
    /// <para>(This method is asynchronous.)</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Retrieves a document with a given ID and object type which 
    /// inherits from ICouchDocument. This method will perform the JSON 
